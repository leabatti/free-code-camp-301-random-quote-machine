...
// The URL source of quotes file is https://gist.github.com/robatron/a66acc0eed3835119817
    ...
    <div className="background" style={{ backgroundColor: randomColor, transition }}>
      <div id="quote-box">
        ...
        <div className="buttons">
          <a
            href={`https://twitter.com/intent/tweet?hashtags=quotes&telated=freecodecamp&text=${quote.quote} - ${quote.author}`}
            id="tweet-quote"
            style={{
